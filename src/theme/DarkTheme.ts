...
const DARK_PRIMARY_THEME: ThemeTypes = {
    name: 'DARK_PRIMARY_THEME',
    dark: true,
    variables: {
        'border-color': '#333F55',
    },
...
export { DARK_PRIMARY_THEME, DARK_BLUE_THEME, DARK_AQUA_THEME, DARK_ORANGE_THEME, DARK_PURPLE_THEME, DARK_GREEN_THEME, DARK_CYAN_THEME };
