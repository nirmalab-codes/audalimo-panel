    ...
    <v-container v-if="driverOfferLetter">
                                ...
                                <v-card-text>
                                    <v-form ref="form" lazy-validation>
                                        <v-row>
                                            ...
                                            <v-col cols="12">
                                                <v-textarea label="Message" v-model="changeNotesFormData.letter_notes"
                        ...
                        <v-dialog v-model="dialogChangeStatus" max-width="500">
                            ...
                            <v-card>
                                        ...
                                        <v-row>
                                            <v-col cols="12" sm="12">
                                                <v-select variant="outlined" hide-details :items="changeStatusEnums"
                                                    v-model="changeStatusFormData.lo_status" label="Status"></v-select>
                                            </v-col>
                                        </v-row>
                                    </v-form>
                                </v-card-text>
                                ...
                                <v-card-actions class="pa-4">
                                    ...
                                    <v-btn color="secondary" :disabled="changeStatusFormData.lo_status == ''"
        ...
        <v-row>
            <v-col cols="12" md="6" class="mb-1">
                ...
                <v-text-field variant="outlined" type="text" hide-details :value="driverOfferLetter?.letter_status"
                    readonly />
            </v-col>
            <v-col cols="12" md="6" class="mb-1">
                <v-label class="font-weight-medium">LO Status</v-label>
                <v-text-field variant="outlined" type="text" hide-details :value="driverOfferLetter?.lo_status"
                    readonly />
            </v-col>
        </v-row>
