        ...
        <v-col cols="12" md="12">
            <v-card elevation="10" class=" " rounded="md">
                <v-tabs v-model="tab" bg-color="transparent" min-height="70" height="70" color="primary">
                    ...
                    <v-tab value="Notification"  class="text-medium-emphasis" disabled><BellIcon class="mr-2" size="20"/>Notification</v-tab>
                    <v-tab value="Bills"  class="text-medium-emphasis" disabled><ArticleIcon class="mr-2" size="20"/>History</v-tab>
                    <v-tab value="Security"  class="text-medium-emphasis" disabled><LockIcon class="mr-2" size="20"/>Security</v-tab>
                </v-tabs>
                <v-divider></v-divider>
